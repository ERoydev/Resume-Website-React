import profileImage from '../../assets/styles/images/profile-img.JPG';
            ...
            <div className="container">
                <section className="content">
                    <div className="text">
                        ...
                        Hi! Im Emil Roydev, a 23 years old Web Developer from Ruse, Bulgaria.
                        <br /> Building scalable web applications with Django and ReactJS.</p>
                        <a href="#" className="projects-btn">Check my projects</a>
                    </div>
